...
* Lock this into an even stricter enterprise-style publishing standard
* Or create a bash script that generates the folder + file structure automatically using a slug argument (`./new-article.sh traefik`)
